...
import GrafikNFT from "./GrafikNFT";

let suhuair = db.ref("SuhuAir/realtime");
let suhulahan = db.ref("DHTNft/SuhuDalam")
let ph = db.ref("PH/realtime");
let ppm = db.ref("PPM/realtime");
let btn1 = db.ref("Button/bt1");
let btn2 = db.ref("Button/bt2");
let btn3 = db.ref("Button/bt3");
...
class NFTPage extends Component {
    ...
    componentDidMount() {
        ...
        suhulahan.on('value', (snapshot) => {
            const SuhuLahan = snapshot.val();
            this.setState({ SuhuLahan });
        })
                ...
                <ImageBackground source={background} style={styles.imagebackground}>
                    <View>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <Text style={styles.judul}>Sistem Monitor NFT</Text>
                        </View>
